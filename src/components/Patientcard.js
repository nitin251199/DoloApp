...
export default function PatientCard({item, onPress, onEdit, onDelete}) {
  return (
    <TouchableOpacity
      activeOpacity={1}
      ...
      <View
        ...
        <View style={styles.listItemText}>
          <Text style={styles.listItemTitle}>Aman</Text>
          <View
            style={{
              flexDirection: 'row',
              alignItems: 'center',
            ...
            <View style={{flexDirection: 'row', width: '65%'}}>
              ...
              <Text style={styles.listItemSubTitle}>Morar,Gwalior</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
              ...
              />
              <Text style={styles.listItemSubTitle}>Male</Text>
            </View>
          </View>
          <View
            style={{
